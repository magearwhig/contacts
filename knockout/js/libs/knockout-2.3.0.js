    ...
    (function(factory) {
      ...
      ko.dependentObservable = function(evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
        ...
        function evaluateImmediate() {
          ...
          if (!_subscriptionsToDependencies.length) dispose();
        }
        ...
        function() {
          return false;
        }, dispose = disposeAllSubscriptionsToDependencies, _subscriptionsToDependencies = [], evaluationTimeoutInstance = null;
      ...
      ko.expressionRewriting = (function() {
        ...
        return {
          ...
          preProcessBindings: function(objectLiteralStringOrKeyValueArray) {
            var keyValueArray = typeof objectLiteralStringOrKeyValueArray === "string" ? ko.expressionRewriting.parseObjectLiteral(objectLiteralStringOrKeyValueArray) : objectLiteralStringOrKeyValueArray;
            var resultStrings = [],
      ...
      (function() {
        ...
        ko.bindingContext = function(dataItem, parentBindingContext, dataItemAlias) {
          ...
          this['$data'] = dataItem;
          if (dataItemAlias) this[dataItemAlias] = dataItem;
        }
        ...
        function applyBindingsToNodeInternal(node, bindings, viewModelOrBindingContext, bindingContextMayDifferFromDomParentElement) {
          ...
          function() {
            ...
            if (!alreadyBound && bindingContextMayDifferFromDomParentElement) ko.storedBindingContextForNode(node, bindingContextInstance);
        ...
        ko.bindingHandlers['template'] = {
          ...
          'update': function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            var templateName = ko.utils.unwrapObservable(valueAccessor()),
              options = {},
              shouldDisplay = true,
              dataValue, templateComputed = null;
      ...
      ko.utils.compareArrays = (function() {
        ...
        function compareArrays(oldArray, newArray, dontLimitMoves) {
          ...
          if (oldArray.length <= newArray.length) return compareSmallArrayToBigArray(oldArray, newArray, statusNotInOld, statusNotInNew, dontLimitMoves);
          else return compareSmallArrayToBigArray(newArray, oldArray, statusNotInNew, statusNotInOld, dontLimitMoves);
        }
        ...
        function compareSmallArrayToBigArray(smlArray, bigArray, statusNotInSml, statusNotInBig, dontLimitMoves) {
          ...
          for (smlIndex = 0; smlIndex <= smlIndexMax; smlIndex++) {
            ...
            for (bigIndex = bigIndexMinForRow; bigIndex <= bigIndexMaxForRow; bigIndex++) {
              ...
              else if (smlArray[smlIndex - 1] === bigArray[bigIndex - 1]) thisRow[bigIndex] = lastRow[bigIndex - 1]; // copy value (no edit)
              else {
          ...
          if (notInSml.length && notInBig.length) {
            ...
            var limitFailedCompares = smlIndexMax * 10,
              failedCompares, a, d, notInSmlItem, notInBigItem;
            // Go through the items that have been added and deleted and try to find matches between them.
            for (failedCompares = a = 0;
            (dontLimitMoves || failedCompares < limitFailedCompares) && (notInSmlItem = notInSml[a]); a++) {
